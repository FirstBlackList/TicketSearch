[![Java CI with Maven](https://github.com/FirstBlackList/TicketSearch/actions/workflows/blank.yml/badge.svg?branch=main)](https://github.com/FirstBlackList/TicketSearch/actions/workflows/blank.yml)
